...
class WebService(QtCore.QThread):
  ...
  #cors = CORS(__app, resources={r"/api/*": {"origins": "*"}})
  CORS(__app)
  ...
  #def start_server():
    ...
    WebService.__app.run(host = WebService.getHost(), port = WebService.getPort())
  ...
  def after_request(response):
      print("after_request S") 
      response.headers['Access-Control-Allow-Origin'] = "*"
      #response.headers['Access-Control-Allow-Origin'] = request.headers['Origin']
      response.headers['Access-Control-Allow-Methods'] = 'PUT, GET, POST, DELETE, OPTIONS' 
      response.headers['Access-Control-Allow-Headers'] = 'Origin, Accept, Content-Type, X-Requested-With, X-CSRF-Token' 
      print("after_request E") 
      return response 
  ...
  @__app.route("/<projectName>/", methods=["GET", "POST"])
  #@__app.route("/<projectName>/", method="POST")
  def default(projectName):
      print("default") 
      filename = "Starter.html"
      return WebService.sendStatic(projectName, filename)

  @route('/<projectName>/<filename:path>', methods=["GET", "POST"])
  def sendStatic(projectName, filename):
      print("sendStatic") 
      return static_file(filename, root = WebService.getCwd())

  @__app.route("/<projectName>/webresources/api/execute", methods=["POST", "GET", "OPTIONS"])
...
class WebView(QWebEngineView):
    ...
    def loadPage(self):
        #self.load(QUrl("file:///C:/Users/Nick/Desktop/usb/QtWebApp/Demo1/etc/docroot/index.html"))
        self.load(QUrl("file:///C:/Users/Development.BLT-ENTERPRISE/Desktop/Desktop/Qt/QtWebApp/Demo1/etc/docroot/index.html"))
        self.show()
    ...
    def loadPage1(self, jsonData):
        ...
        webView.load(QUrl("file:///C:/Users/Development.BLT-ENTERPRISE/Desktop/Desktop/Qt/QtWebApp/Demo1/index.html"))
        #self.show()

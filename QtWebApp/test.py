...
class WebService(QtCore.QThread):
  ...
  def webService(projectName):
      ...
      print(ws)
      ws.load(QUrl("file:///C:/Users/Development.BLT-ENTERPRISE/Desktop/Desktop/Qt/QtWebApp/Demo1/index.html"))
      ws.show()
      sys.exit(app.exec_())
...
if __name__ == "__main__":
    ...
    """
    e1 = QWebEngineView()
    e1.load(QUrl("file:///C:/Users/Development.BLT-ENTERPRISE/Desktop/Desktop/Qt/QtWebApp/Demo1/etc/docroot/index.html"))
    e1.show()
    e2 = QWebEngineView()
